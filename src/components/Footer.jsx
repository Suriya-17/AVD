        ...
        <FooterContainer>
            <FooterLinks>
                ...
                <SocialMediaLinks>
                    ...
                    <li>
                        <Link><i className="fa-brands fa-linkedin fa-xl"></i></Link>
                    </li>
                    <li>
                        <Link><i className="fa-brands fa-youtube fa-xl"></i></Link>
                    </li>
                </SocialMediaLinks>
            </FooterLinks>
            <CopyRightText> &copy; 2025 Arjun Digital Solutions. All Rights Reserved.</CopyRightText>
        </FooterContainer>
